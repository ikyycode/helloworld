            ...
            <div class="row">
              <div class="col-lg-5 col-12">
                <div class="item-bootcamp">
                  ...
                  <p class="description">
                    Bootcamp ini akan mengajak Anda untuk belajar penuh mulai
                    dari pengenalan dasar sampai membangun sebuah projek asli
                  </p>
                </div>
              </div>
              ...
              <div class="col-lg-6 col-12">
                <form action="{{ route('success-checkout') }}" class="basic-form">
                  ...
                  <p class="text-center subheader mt-4">
                    <img src="{{asset('images/ic_secure.svg')}}" alt="" /> Your
