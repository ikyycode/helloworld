...
<html lang="en">
  <head>
    ...
    <title>HelloWorld - Bootcamp Terbaik #1</title>
  </head>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Stackoverflow</a>
            </li>
            <li class="nav-item">
          ...
          <div class="col-lg-11 col-12">
            <div class="row">
              <div class="col-lg-6 col-12 copywriting">
                <p class="story">To change the World, start from us</p>
                <h1 class="header">
                  Ngoding Aja Dulu,
                  <br />
                  Jago Mah Belakangan.
        ...
        <div class="row">
          <div class="col-lg-3 col-12">
            <div class="item-benefit">
              ...
              <p class="support">
                Learn from anyone around the <br />
                world and get a new skills
              </p>
            </div>
          </div>
          <div class="col-lg-3 col-12">
            <div class="item-benefit">
              ...
              <p class="support">
                Lara will help you to choose <br />
          ...
          <div class="col-lg-3 col-12">
            <div class="item-benefit">
              ...
              <p class="support">
                We will ensure that you will get <br />
          ...
          <div class="col-lg-3 col-12">
            <div class="item-benefit">
              ...
              <p class="support">
                Get your dream job in your dream <br />
      ...
      <div class="container">
        ...
        <div class="row item-step pb-70">
          <div class="col-lg-6 col-12 text-left copywriting pl-150">
            ...
            <p class="support">
              Each of you will be joining the private group and also <br />
          ...
          <div class="col-lg-10 col-12">
            <div class="row">
              <div class="col-lg-4 col-12">
                <div class="item-review">
                  ...
                  <div class="user">
                    <img
                      src="{{asset('images/rizki_photo.png')}}"
                      class="photo"
                      alt=""
                    />
                    <div class="info">
                      <h4 class="name">Rizki</h4>
                      <p class="role">CEO at HelloWorld</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-12">
                <div class="item-review">
                  ...
                  <div class="user">
                    <img src="{{asset('images/nia.png')}}" class="photo" alt="" />
                    <div class="info">
                      <h4 class="name">Nia</h4>
                      <p class="role">Developer Game</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-12">
                <div class="item-review">
                  ...
                  <div class="user">
                    <img src="{{asset('images/ria.png')}}" class="photo" alt="" />
                    <div class="info">
            ...
            <div class="row copyright">
              <div class="col-lg-12 col-12">
                <p>All Rights Reserved. Copyright HelloWorld Indonesia.</p>
              </div>
            </div>
          </div>
        </div>
